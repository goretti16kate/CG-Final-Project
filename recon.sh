...
#Running Whatweb to get the technologies used
# printf "\n${MAGENTA}Running Whatweb....${ENDCOLOR}\n"
# while read line 
# do 
...
#get open http ports to run gobuster and whatweb
# for httport in $httports 
# do
# 	printf "${MAGENTA}Running Gobuster on port $httport.....${ENDCOLOR}"
# 	printf "\n${RED} Directories for port $httport ${ENDCOLOR}\n" >> temp1
# 	gobuster dir -u http://$ip:$httport -w /usr/share/wordlists/dirb/common.txt -qz >> temp1
# done

#record the recon details and then clean the space by removing the files
# if [ -e temp1 ]
# then
# 	printf "\n${CYAN}----- FOUND DIRECTORIES -----${ENDCOLOR}\n\n" >> results
# 	cat temp1 >> results
# 	rm temp1
# fi
...
# if [ -e temp2 ]
# then 
# 	printf "\n${CYAN}----- WEB TECHNOLOGIES -----${ENDCOLOR}\n\n" >> results
# 	cat temp2 >> results
# 	rm temp2
# fi 
